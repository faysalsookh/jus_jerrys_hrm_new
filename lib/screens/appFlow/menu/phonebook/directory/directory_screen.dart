      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            buildProfileDetails(
              title: tr("phone"),
              description: widget.phonebookDetails?.data?.phone ?? tr("n/a"),
            ),
            buildProfileDetails(
              title: tr("email"),
              description: widget.phonebookDetails?.data?.email ?? tr("n/a"),
            ),
            buildProfileDetails(
              title: tr("department"),
              description:
            ...
            buildProfileDetails(
              ...
              description:
                  widget.phonebookDetails?.data?.facebookLink ?? tr("n/a"),
            ),
          ],
        ),
      ),
